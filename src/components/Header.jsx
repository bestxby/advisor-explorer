export default function Header({ children }) {
  return (
    <header data-animate="header" className="bg-gradient-to-br from-primary-dark via-primary to-primary-light text-white py-8 px-8 md:px-10 relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4 items-center">
          ...
          <div className="md:col-span-3 flex flex-col gap-3">
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm font-medium text-white/80 tracking-wide uppercase">Advisor Explorer</span>
            </div>

            {/* Main title */}
            <h1 className="text-[3.5rem] md:text-[4.5rem] lg:text-[5.5rem] font-black leading-[1.05] font-heading tracking-tight">
              计算机体系结构
              <br />
