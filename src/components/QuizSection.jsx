  ...
  if (results) {
    ...
    return (
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 md:p-8 text-center">
        ...
        <h3 className="text-lg font-bold text-gray-900 mb-1">匹配完成</h3>
        <p className="text-gray-500 text-sm mb-4">你的最佳方向是 <span className="font-semibold text-primary">{top.directionName}</span>，匹配度 {top.score}%</p>
        <p className="text-xs text-gray-400 mb-4">详细结果和路线图展示在下方</p>
        <button
          onClick={reset}
          className="inline-flex items-center gap-2 px-5 py-2.5 bg-gray-50 text-gray-700 rounded-xl font-semibold border border-gray-200 hover:bg-gray-100 hover:shadow-sm transition-all duration-200 cursor-pointer text-sm"
        >
