    ...
    <div
      className={`relative rounded-xl p-4 border-2 transition-all ${
        best
          ...
          : 'border-[#2a3550] bg-[#111a2e]/50 opacity-75'
      }`}
    >
      {best && (
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div className="flex items-center gap-3 min-w-0">
          ...
          <span
            className={`font-bold min-w-0 break-words ${best ? 'text-primary' : 'text-slate-300'}`}
          >
        ...
        <div className="flex items-center gap-2">
          <div className="w-20 h-2 bg-[#2a3550] rounded-full overflow-hidden">
            <div
          ...
          <span
            className={`text-sm font-bold ${best ? 'text-primary' : 'text-slate-400'}`}
          >
            {result.score}%
          </span>
        </div>
