          ...
          <section className="relative">
            ...
            <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-xl p-6 border border-amber-100">
              ...
              <div className="flex items-start gap-2 bg-white/60 rounded-lg p-3 border border-amber-200">
                ...
                <p className="text-sm text-amber-800 font-medium">适合谁：{professor.suitableFor}</p>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-gray-50 rounded-xl p-5 border border-gray-100">
                <p className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-3">核心技术栈</p>
                <div className="flex flex-wrap gap-2">
                  {professor.techStack.map(tech => (
                    <span key={tech} className="inline-flex items-center px-3 py-1.5 bg-white text-indigo-700 text-xs font-semibold rounded-lg border border-indigo-100 shadow-sm">
                      {tech}
                    </span>
                  ))}
                </div>
              ...
              <div className="bg-gray-50 rounded-xl p-5 border border-gray-100">
                <p className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-3">顶会/顶刊</p>
                <div className="flex flex-wrap gap-2">
                  {professor.conferences.map(conf => (
                    <span key={conf} className="inline-flex items-center px-3 py-1.5 bg-white text-emerald-700 text-xs font-semibold rounded-lg border border-emerald-100 shadow-sm">
                      {conf}
                    </span>
                  ))}
                </div>
