const CONTROL_ICON_PATHS = {
  ...
  sort:
    'M3 7.5L7.5 3m0 0L12 7.5M7.5 3v13.5m13.5-3L16.5 18m0 0L12 13.5m4.5 4.5V6',
  close: 'M6 18L18 6M6 6l12 12',
};

export default function ControlIcon({ type, className = 'w-4 h-4', strokeWidth = 2 }) {
  return (
    <svg
      aria-hidden="true"
      className={className}
    ...
    >
      <path strokeLinecap="round" strokeLinejoin="round" d={CONTROL_ICON_PATHS[type]} />
    </svg>
  );
}
